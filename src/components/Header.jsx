            ...
            <div className='w-[90%] lg:max-w-[1000px] mx-auto flex flex-col-reverse gap-5 md:gap-0 md:flex-row justify-between items-center '>
                ...
                <div data-aos="fade-up" className='w-[100%] md:w-[45%]' >
                    ...
                    <div className='flex gap-4' >
                        ...
                        {/* <a href="https://github.com/krrishSinha" target='_blank' className='transition-all duration-200 hover:scale-[1.08]  bg-white overflow-hidden rounded-full ' >
                ...
                <div data-aos="fade-down" className=' py-5 w-[100%] md:w-[40%] relative z-10 '>
                    ...
                    <div className='relative z-10 w-full' >
                        ...
                        <div className={`bg-headerImg w-[100%] h-[300px] bg-cover bg-center rounded-xl block md:hidden`} >
                        </div>

                        {/* <div className='md:hidden block' >
                            <img src={headerImg} alt="" className='mx-auto rounded-3xl w-[80%] sm:w-[60%] ' />
                        </div> */}
