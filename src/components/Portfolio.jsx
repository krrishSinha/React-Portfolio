                ...
                title == 'Portfolio' ?
                    ...
                    <div className={`bg-[#494B50] px-10 py-10 rounded-xl scale-[0.99] transition-all duration-1000`}>
                        ...
                        <div className='mb-16' >
                            ...
                            <h2 className='text-4xl font-extrabold' >My works that I did <br /> for clients</h2>
                        </div>

                        {/* portfolio div  */}
                        <div>

                            <div className='flex justify-center my-10 gap-8 text-lg font-bold' >
                            ...
                            <div className='grid grid-cols-3 gap-10 items-center z-10 ' >
                                ...
                                <div className={`h-full group relative before:content-[''] before:absolute before:w-full before:h-full before:rounded-xl before:z-[-10] before:scale-0   before:bg-red-500 before:bg-opacity-80 hover:before:z-[1] hover:before:scale-100 hover:before:scale-100 before:transition-all before:duration-200 cursor-pointer`}>
                                    ...
                                    <img className='h-full rounded-xl bg-cover ' src="https://shtheme.com/demosd/iknow/wp-content/uploads/2022/02/2-2.jpg" alt="" />
                                ...
                                <div className={`h-full group relative before:content-[''] before:absolute before:w-full before:h-full before:rounded-xl before:z-[-10] before:scale-0   before:bg-red-500 before:bg-opacity-80 hover:before:z-[1] hover:before:scale-100 hover:before:scale-100 before:transition-all before:duration-200 cursor-pointer`}>
                                    ...
                                    <img className='h-full rounded-xl bg-cover ' src="https://shtheme.com/demosd/iknow/wp-content/uploads/2022/02/3-2.jpg" alt="" />
